...
const runFinalComputationRGAA = (pagesResultsArray) => {
	...
	*/
	nbNTResultsArray = getNbNotTested();
	let nbNT = nbNTResultsArray.total;
	...
	computationContent += `
		<h2 class="pt-4 pb-3">${langVallydette.auditTxt14}</h2>
		${nbNT >= 1 ? '<div class="alert alert-warning" role="alert"><span class="alert-icon"></span><p>langVallydette.auditTxt2</p></div>' : ''}
		<p class="h3">${langVallydette.auditTxt1} : <span class="text-primary">${dataRGAA.result}%</span></p>
		<p class="h3 pb-3">${langVallydette.auditTxt13} : <span class="text-primary">${dataRGAA.globalPagesResult}%</span></p>
		<ul class="nav nav-tabs" role="tablist">
			<li class="nav-item" role="presentation">
				<button class="nav-link active" id="tabResultatPage" data-bs-toggle="tab" data-bs-target="#resultatPage" type="button" role="tab" aria-controls="resultatPage" aria-selected="true">${langVallydette.auditTxt3}</button>
			</li>
			<li class="nav-item" role="presentation">
				<button class="nav-link" id="tabsynthesePages" data-bs-toggle="tab" data-bs-target="#synthesePages" type="button" role="tab" aria-controls="synthesePages" aria-selected="false">${langVallydette.auditTxt18}</button>
			</li>
			<li class="nav-item" role="presentation">
